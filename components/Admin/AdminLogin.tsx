...
const AdminLogin: React.FC<AdminLoginProps> = ({ onLogin }) => {
    ...
    return (
        <div className="min-h-screen bg-bg-dark flex items-center justify-center p-4">
            <div className="bg-surface-1 border border-black/10 p-8 rounded-2xl shadow-2xl w-full max-w-md backdrop-blur-md">
                ...
                <form onSubmit={handleLogin} className="space-y-6">
                    <div>
                        ...
                        <input
                            type="email"
                            required
                            className="w-full bg-bg-deep border border-black/10 rounded-lg px-4 py-3 text-ink focus:border-lilac focus:ring-1 focus:ring-lilac outline-none transition-all"
                    ...
                    <div className="text-center pt-4">
                        <a href="/" className="text-xs text-text-subtle hover:text-ink transition-colors">
                            ← Back to Website
                        </a>
                    </div>
                </form>

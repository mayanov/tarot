          ...
          <div className="lg:col-span-4">
            <FadeIn>
              <div className="lg:sticky lg:top-28">
                ...
                <p className="mt-5 text-ink font-light leading-relaxed max-w-xs">
                  {isIndonesian
                  ...
                  <FadeIn key={index} delay={Math.min(index, 6) * 40}>
                    <div className="border-b border-black/10">
                      ...
                      >
                        ...
                        <ChevronDown className={`w-5 h-5 shrink-0 transition-all duration-300 ${open ? 'text-moon-deep rotate-180' : 'text-ink/60'}`} />
                      </button>

                      <div className={`grid transition-all duration-300 ease-out ${open ? 'grid-rows-[1fr] opacity-100' : 'grid-rows-[0fr] opacity-0'}`}>
                        <div className="overflow-hidden">
                          <p className="pb-5 pr-10 text-ink text-[0.95rem] md:text-base leading-relaxed whitespace-pre-line font-light">
                            {faq.answer}
                          </p>
                        </div>
                      </div>
